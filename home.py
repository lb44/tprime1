...
def func13():
    ...
    sbmibtn = Button(screen2, text='Bank Accounts',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=120)
    sbmibtn = Button(screen2, text='Bank OCC A/c',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=140)
    sbmibtn = Button(screen2, text='Bank OD A/c',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=160)
    sbmibtn = Button(screen2, text='Branch /Divisions',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=180)
    sbmibtn = Button(screen2, text='Capital Account',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=200)
    sbmibtn = Button(screen2, text='Cash in Hand ',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=220)
    sbmibtn = Button(screen2, text='Current Assets',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=240)
    sbmibtn = Button(screen2, text='Current Liabilities',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=260)
    sbmibtn = Button(screen2, text='Deposits (Assets)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=280)
    sbmibtn = Button(screen2, text='Direct Expenses',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=300)
    sbmibtn = Button(screen2, text='Direct Incomes',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=320)
    sbmibtn = Button(screen2, text='Duties and Taxes',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=340)
    sbmibtn = Button(screen2, text='Expenses(Direct)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=360)
    sbmibtn = Button(screen2, text='Expenses(Indirect)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=380)
    sbmibtn = Button(screen2, text='Fixed Assets',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=400)
    sbmibtn = Button(screen2, text='Income(Direct)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=420)
    sbmibtn = Button(screen2, text='Income (Indirect)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=440)
    sbmibtn = Button(screen2, text='Indirect Expenses',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=460)
    sbmibtn = Button(screen2, text='Indirect Incomes',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=480)
    sbmibtn = Button(screen2, text='Investments',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=500)
    sbmibtn = Button(screen2, text='Loans and Advances(Assets)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=520)
    sbmibtn = Button(screen2, text='Loans (Liability)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=540)
    sbmibtn = Button(screen2, text='Misc. Expenses(ASSET)',command=create9,fg='black',font=('Arial',9),activebackground='palegreen',width=30,border=0).place(x=665,y=560  )
